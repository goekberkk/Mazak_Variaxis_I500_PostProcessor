...
# tool numbers (which were already updated before this fires).
  ...
  if { $is_new_tool } {
    # New tool: G_plane already forced by start_of_operation_force_addresses.
    # Force S and M_spindle — both will output.
    MOM_force Once S M_spindle
...
# No sequence numbers (MOM_set_seq_off should be active).
  ...
  MOM_output_literal [format "( %-16s: %-40s)" "THIS POSTPROCESSOR IS INCOMPLETE. IT SHOULD NOT BE USED UNDER ANY CIRCUMSTANCES. I AM NOT RESPONSIBLE FOR ANY CRASHES, INJURIES, OR DAMAGE RESULTING FROM ITS USE."]
